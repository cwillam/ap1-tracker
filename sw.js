const CACHE_NAME = "ap1-tracker-v3.0.13";
const ASSETS = [
	"index.html",
	"subnet.html",
	"sql.html",
	...
	"assets/js/questions.js?v=3.0.13",
	"assets/js/app.js?v=3.0.0",
	"assets/js/subnet.js?v=3.0.12",
...
self.addEventListener("fetch", (event) => {
	...
	// HTML-Navigationen: Network-First (Offline-Fallback auf Cache)
